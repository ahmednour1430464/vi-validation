...
return [
    ...
    'decimal' => 'يجب أن يكون :attribute رقماً يحتوي على :min إلى :max خانات عشرية.',
    'list' => 'يجب أن يكون :attribute قائمة (مصفوفة متسلسلة).',
    ...
    'min_file_size' => 'يجب أن يكون حجم :attribute على الأقل :min كيلوبايت.',
    ...
    'prohibits' => 'حقل :attribute يمنع وجود :fields.',
    ...
    'missing_with_all' => 'يجب أن يكون حقل :attribute مفقوداً عند وجود كل من :values.',
];
